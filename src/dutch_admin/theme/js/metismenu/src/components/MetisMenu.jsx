...
class MetisMenu extends React.Component {
  constructor(props) {
    ...
    this.classStore = {
      ...
      classLinkHasChild: classnames(
        { 'has-active-child': !props.noBuiltInClassNames },
        props.classNameLinkHasChild,
      ),
      classLinkHasActiveChild: classnames(
        { 'has-active-child': !props.noBuiltInClassNames },
        props.classNameLinkHasActiveChild,
      ),
      classTextSpan: classnames(
        { 'nav-text': !props.noBuiltInClassNames },
        props.classNameTextSpan,
      ),
...
MetisMenu.propTypes = {
  ...
  classNameLinkHasChild: PropTypes.string,
  ...
  classNameTextSpan: PropTypes.string,
