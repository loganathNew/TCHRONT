                        ...
                        <div className="card mb-sm-3 mb-md-0 contacts_card dz-chat-user-box">
                            <div className="card-header chat-list-header text-center">
                                <a href="#/"><svg xmlns="http://www.w3.org/2000/svg"
                                    xmlnsXlink="http://www.w3.org/1999/xlink" width="18px" height="18px"
                            ...
                            <div className="card-header chat-list-header text-center">
                                ...
                                <div className="dropdown">
                                    ...
                                    <ul className="dropdown-menu dropdown-menu-right">
                                        <li className="dropdown-item"><i className="fa fa-user-circle text-primary mr-2"></i>
                                            View profile</li>
                                        <li className="dropdown-item"><i className="fa fa-users text-primary mr-2"></i> Add to
                                            close friends</li>
                                        <li className="dropdown-item"><i className="fa fa-plus text-primary mr-2"></i> Add to
                                            group</li>
                                    ...
                                    <li className="active">
                                        <div className="d-flex bd-highlight">
                                            ...
                                            <div className="ml-auto">
                                                <a href="#/" className="btn btn-primary btn-xs sharp mr-1"><i
                                                    className="fa fa-pencil"></i></a>
                                                <a href="#/" className="btn btn-danger btn-xs sharp"><i
